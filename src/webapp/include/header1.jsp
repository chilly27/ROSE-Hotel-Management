...
<html lang="en">
	...
	.voucher {
		flex: 1;
		margin: 5px; /* Điều chỉnh khoảng cách giữa các khung voucher */
		...
		.voucher img {
			width: 100%; /* Đảm bảo hình ảnh phủ đầy khung */
                ...
                <div class="top-bar">
                    <div class="content-topbar flex-sb-m h-full container">
                        ...
                        <div class="right-top-bar flex-w h-full">
                            ...
                            <c:if test="${sessionScope.account != null}">
                                <a href="viewprofile?username=${sessionScope.account.userName}" class="flex-c-m trans-04 p-lr-25">
                                My Account
                            </a>
                            ...
                            <a href="revenue.jsp" class="flex-c-m trans-04 p-lr-25">
                                Revenue
                            </a>
                        </div>
                    </div>
