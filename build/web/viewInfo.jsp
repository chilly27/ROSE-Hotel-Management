...
<body class="animsition">
            ...
            <div class="top-bar">
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        <a href="Profile-Customer.html" class="flex-c-m trans-04 p-lr-25">
                            My Account
                        </a>
    ...
    <div class="container-fluid">
        <form action="viewprofile" class="bg0 p-t-75 p-b-85" method="post">
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                            ...
                            <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                                ...
                                <c:choose>
                                    ...
                                    <input class="w-100 stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5"
                                        type="text" placeholder="User Name" value="${c.userName}" readonly>
                                </div>
                        ...
                        <select id="gender" name="gender" disabled>
                            ...
                            <option value="W" ${c.gender == 'W' ? 'selected' : ''}>Female</option>
                            <option value="O" ${c.gender == 'O' ? 'selected' : ''}>Other</option>
                        </select>
                    </div>

                                <div class="flex-w flex-l m-r-20 m-tb-5 w-100">
                                    <input class="w-100 stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5"
                                           type="date" placeholder="Date of birth" name="dob"value="${c.dob}" >
                                </div>

                                <div class="flex-w flex-l m-r-20 m-tb-5 w-100">
                                    <input class="w-100 stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5"
                                           type="text" placeholder="Phone Number" name="phone" value="${c.phone}">
                                </div>
                                <div class="flex-w flex-l m-r-20 m-tb-5 w-100">
                                    <input class="w-100 stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5"
                                           type="text" placeholder="Address" name="address" value="${c.address}">
                                </div>

                                <div class="flex-w flex-l m-r-20 m-tb-5 w-100">
                                    <input class="w-100 stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5"
                                        type="text" value="name@gmail.com" value="${c.email}"readonly>
                                    <div class="container">
